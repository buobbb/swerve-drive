...
public class SwerveModuleKooky {
    ...
    public SwerveModuleKooky(DcMotorEx m, CRServo s, AbsoluteAnalogEncoder e) {
        motor = m;
...
//    }
    ...
    public void update() {
        ...
        if (++vCount >= 10) { voltage = vs.getVoltage(); vCount = 0; }
            ...
            double target = getTargetRotation() - Math.PI, current = getModuleRotation() - Math.PI;
    ...
    public static class SwerveModuleState {
        public SwerveModuleKooky module;
        public double wheelPos, podRot;

        public SwerveModuleState(SwerveModuleKooky s) {
            module = s;
            wheelPos = 0;
            podRot = 0;
        }
